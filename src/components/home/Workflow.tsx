            ...
            >
              <Card customClass="border-2 border-zinc-800 p-8 bg-zinc-900 group hover:border-indigo-500/50 transition-[border-color] duration-300">
                ...
                <p className="text-zinc-400 mb-4 leading-relaxed p-8 rounded-3xl bg-zinc-800 relative overflow-hidden">
                  ...
                  <span className="relative">
                    Bắt đầu bằng việc lắng nghe kỹ càng về ý tưởng, mục tiêu
                    kinh doanh và thách thức của bạn. Tôi sẽ phân tích yêu cầu,
                    nghiên cứu thị trường và đề xuất giải pháp công nghệ phù hợp
                    nhất.
                  </span>
                </p>
              </Card>
              <Card customClass="border-2 border-zinc-700 p-8 bg-zinc-900 group hover:border-violet-500/50 transition-[border-color] duration-300">
                ...
                <p className="text-zinc-400 mb-4 leading-relaxed p-8 rounded-3xl bg-zinc-800 relative overflow-hidden">
                  ...
                  <span className="relative">
                    Xây dựng kiến trúc hệ thống, thiết kế giao diện UX/UI tối ưu
                    và lập kế hoạch triển khai chi tiết. Mọi quyết định đều
                    hướng đến trải nghiệm người dùng tốt nhất và khả năng mở
              ...
              <Card customClass="border-2 border-zinc-700 p-8 bg-zinc-900 group hover:border-purple-500/50 transition-[border-color] duration-300">
                ...
                <p className="text-zinc-400 mb-4 leading-relaxed p-8 rounded-3xl bg-zinc-800 relative overflow-hidden">
                  ...
                  <span className="relative">
                    Code được viết theo chuẩn clean code, có tính bảo trì cao.
                    Liên tục test, tối ưu hiệu năng và bảo mật. Bạn sẽ được cập
                    nhật tiến độ thường xuyên và có thể trải nghiệm sản phẩm
                    sớm.
                  </span>
                </p>
              </Card>
              <Card customClass="border-2 border-zinc-700 p-8 bg-zinc-900 group hover:border-pink-500/50 transition-[border-color] duration-300">
                ...
                <p className="text-zinc-400 mb-4 leading-relaxed p-8 rounded-3xl bg-zinc-800 relative overflow-hidden">
                  ...
                  <span className="relative">
                    ...
                    Hướng dẫn sử dụng, bàn giao tài liệu đầy đủ và luôn sẵn sàng
                    hỗ trợ, cập nhật tính năng mới theo nhu cầu phát triển của
                    bạn.
                  </span>
                </p>
              </Card>
